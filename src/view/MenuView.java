...
public class MenuView extends JFrame {
    ...
    private void createUIComponents() {
        ...
        reserveAppointmentView = new AppointmentView( null, false, "Reserve appointment", true, false) {
            @Override
            public void onAppointmentAction(Appointment appointment) {
                boolean result = new AppointmentDAO().update(appointment, patient);
                if(result) {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "The appointment is already reserved by someone else!", "Info", JOptionPane.INFORMATION_MESSAGE);
                    reserveAppointmentView.updateAppointmentList();
                }
